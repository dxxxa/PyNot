...
class BitcoinBrainWallet:
    ...
    def generate_address(private_key):
        public_key = BitcoinBrainWallet.__private_to_public(private_key)
        address = BitcoinBrainWallet.__public_to_address(public_key)
        return address

    @staticmethod
    def generate_compressed_address(private_key):
        public_key = BitcoinBrainWallet.__private_to_compressed_public(private_key)
        address = BitcoinBrainWallet.__public_to_address(public_key)
        return address
