    ...
    for form in forms:
        ...
        for i in "\"'":
            ...
            if vulnerable(res):
                ...
                print("No SQL injection attack vulnerability detected / Уязвимость атаки SQL-инъекцией не обнаружена")
                break


if __name__ == "__main__":
    urlToBeChecked = "https://esim.firpo.ru/user/profile/edit/1583"
